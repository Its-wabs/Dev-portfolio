...
const BackToLanding = ({ onClose }: BackToLandingProps) => {
  return (
    <button
      onClick={onClose}
      className="fixed bottom-7 left-2 z-[110] flex items-center gap-3 bg-[#63938C] text-white px-5 py-3 hover:bg-black hover:text-white transition-colors duration-300 group"
    >
